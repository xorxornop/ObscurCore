...
{
    /// <summary>
    ///     Symmetric block cipher padding types able to be used in a <see cref="CipherStream" />
    ...
    public enum BlockCipherPadding
    {
        ...
        /// <summary>
        ///     ANSI X.923 - Zero bytes (0x00) are added as required until last padding byte; byte value is number of padding bytes
        ///     added.
        /// </summary>
        X923
    }
