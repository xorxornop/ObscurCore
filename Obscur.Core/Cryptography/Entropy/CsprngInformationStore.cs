...
namespace Obscur.Core.Cryptography.Entropy
{
    internal static class CsprngInformationStore
    {
        internal static readonly ImmutableDictionary<CsPseudorandomNumberGenerator, CsprngDescription> CsprngDictionary;

        static CsprngInformationStore()
        {
