...
{
    [ProtoContract]
    public class PayloadSchemeConfiguration : IDataTransferObject, IEquatable<PayloadSchemeConfiguration>,
        IPayloadSchemeConfiguration
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (PayloadSchemeConfiguration)) {
                return false;
            }
