...
{
    /// <summary>
    ///     Factory for <see cref="AuthenticationConfiguration" /> data transfer objects,
    ///     used for configuring the operation of ciphers in a <see cref="MacStream" /> or <see cref="HashStream" />.
    /// </summary>
    /// <remarks>
    ///     Use of a <see cref="AuthenticationConfiguration" /> is not required for use of 
	...
	public static class AuthenticationConfigurationFactory
	{
        ...
        internal const BlockCipher DefaultCmacCipher = BlockCipher.Threefish;
	    ...
	    /// <summary>
        /// Creates a <see cref="AuthenticationConfiguration" /> using a HMAC construction.
	    /// </summary>
	    /// <remarks>
        ...
        /// <returns>The authentication configuration as a <see cref="AuthenticationConfiguration" />.</returns>
	    public static AuthenticationConfiguration CreateAuthenticationConfigurationHmac (HashFunction hashEnum, 
			out int outputSize, int? keySize = null) 
		{
			outputSize = Athena.Cryptography.HashFunctions[hashEnum].OutputSizeBits / 8;
		...
		private static AuthenticationConfiguration CreateAuthConf(string functionName, int keySizeBits, int outputSizeBits, byte[] functionConfig, byte[] nonce) {
