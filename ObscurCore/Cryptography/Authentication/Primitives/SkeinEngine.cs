...
namespace ObscurCore.Cryptography.Authentication.Primitives
{
		...
		: IMemoable
	{
	     ...
	     * pre-message params.
	     */
		private static readonly IDictionary INITIAL_STATES = new Hashtable();
		...
		private class UbiTweak
		{
			...
			{
				this.tweak = tweak.tweak.DeepCopy ();
		...
		public SkeinEngine(int blockSizeBits, int outputSizeBits)
		{
			...
			this.ubi = new UBI(this,threefish.BlockSize);
		}
		...
		{
			get { return threefish.BlockSize; }
		}
		...
		private void InitParams(IDictionary parameters)
		{
			...
			IList pre = new ArrayList ();
			IList post = new ArrayList ();
