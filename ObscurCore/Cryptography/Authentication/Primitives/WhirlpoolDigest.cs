...
namespace ObscurCore.Cryptography.Authentication.Primitives
{
    ...
    */
    public sealed class WhirlpoolDigest : IDigest
    {
        ...
        private static readonly ulong[] C0 = new ulong[] {
        ...
        private static readonly ulong[] C1 = new ulong[] {
        ...
        private static readonly ulong[] C2 = new ulong[] {
        ...
        private static readonly ulong[] C3 = new ulong[] {
        ...
        private static readonly ulong[] C4 = new ulong[] {
        ...
        private static readonly ulong[] C5 = new ulong[] {
        ...
        private static readonly ulong[] C6 = new ulong[] {
        ...
        private static readonly ulong[] C7 = new ulong[] {
        ...
        private readonly ulong[] _rc = new ulong[] {
                    0x0000000000000000,
                    0x1823c6e887b8014f,
                    0x36a6d2f5796f9152,
                    0x60bc9b8ea30c7b35,
        ...
        public int DoFinal(byte[] output, int outOff)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                convertULongToByteArray(_hash[i], output, outOff + (i * 8));
            }
        ...
        private void processFilledBuffer()
        {
            ...
            {
                _block[i] = bytesToULongFromBuffer(_buffer, i * 8);
                //_block[i] = BitConverter.ToUInt64(_buffer, i * 8);
            }
        ...
        private static ulong bytesToULongFromBuffer(byte[] buffer, int startPos)
		{
        ...
        private static void convertULongToByteArray(ulong inputLong, byte[] outputArray, int offSet)
        {
            for (int i = 0; i < 8; i++)
            {
