		...
		: BufferedBlockCipher
    {
        ...
        */
        public CtsBlockCipher(
            IBlockCipher cipher)
        {
            // Modified by Matthew Ducker 29-10-2012. Removed option for ECB, because ECB sucks. 
            // Changed to inclusive CBC mode test, not exclusion test.
			if (!(cipher is CbcBlockCipher))
                throw new ArgumentException("CtsBlockCipher can only accept a CBC base cipher"); // edited message, see above.
