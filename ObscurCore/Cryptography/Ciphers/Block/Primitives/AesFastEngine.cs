		...
		: IBlockCipher
    {
        ...
        */
			...
			uint[,] KW)
        {
             ...
             * Placing all precomputes in one array requires offsets additions for 8/16/24 rotations but avoids 
             * additional array range checks on 3 more arrays (which are more expensive than the offset additions).
             */
