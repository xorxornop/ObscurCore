...
namespace ObscurCore.Cryptography.KeyAgreement
{
	public static class NamedEllipticCurves
	{
		...
		static NamedEllipticCurves ()
		{
			...
			Curves.Add (Sec2EllipticCurve.Secp224k1.ToString (), new FpEcNamedCurveInformation {
				Name = Sec2EllipticCurve.Secp224k1.ToString (),
				DisplayName = "secp224k1",
				BitLength = 224,
				Q = "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D",
				A = "0",
				B = "05",
				G = "04"
			...
			Curves.Add (Sec2EllipticCurve.Secp224r1.ToString (), new FpEcNamedCurveInformation {
			...
			Curves.Add (Sec2EllipticCurve.Secp384r1.ToString (), new FpEcNamedCurveInformation {
				Name = Sec2EllipticCurve.Secp224r1.ToString (),
				DisplayName = "secp224r1",
				BitLength = 224,
				Q = "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF",
