...
//			F2mFieldElement.CheckFieldElements(a.x, b.x);
		...
		/* (non-Javadoc)
		 * @see ObscurCore.Cryptography.BouncyCastle.math.ec.ECPoint#add(ObscurCore.Cryptography.BouncyCastle.math.ec.ECPoint)
		 */
		...
		/* (non-Javadoc)
		 * @see ObscurCore.Cryptography.BouncyCastle.math.ec.ECPoint#subtract(ObscurCore.Cryptography.BouncyCastle.math.ec.ECPoint)
		 */
		public override ECPoint Subtract(
			ECPoint b)
		{
		...
		/* (non-Javadoc)
		 * @see ObscurCore.Cryptography.BouncyCastle.Math.EC.ECPoint#twice()
		 */
		public override ECPoint Twice()
		{
			// Twice identity element (point at infinity) is identity
