...
namespace ObscurCore.Packaging
{
	...
	public sealed class FrameshiftPayloadMux : SimplePayloadMux
	{
		...
		protected override void EmitTrailer (MacStream authenticator) { EmitHeader(authenticator); }
		...
		protected override void ConsumeTrailer (MacStream authenticator) { ConsumeHeader(authenticator); }
	}
}
