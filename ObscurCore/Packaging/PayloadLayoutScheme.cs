...
{
	/// <summary>
	/// Schemes for how data constituting payload items is spatially arranged (sequence-wise) relative to each item.
	/// </summary>
	public enum PayloadLayoutScheme
	{
		...
		Simple,
		/// <summary>
		/// Items written/read in randomly-shuffled order, with fixed/variable lengths of random data padding the start and end of each.
		/// </summary>
